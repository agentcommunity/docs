...
This is the problem Agent Interface Discovery [AID] (new name: Agent Identity & Discovery) solves. And it solves it in the most obvious way imaginable: it uses DNS.
...
- [AID Specification](https://docs.agentcommunity.org/aid/specification)
- [Design Rationale](https://docs.agentcommunity.org/aid/rationale)
- [Quick Start Guide](https://docs.agentcommunity.org/aid/quickstart)
