...
<img alt="Editorial illustration: an orange fortress labeled ." src="/blog/editorial-illustration-an-orange-fortress-labeled-.png" />
...
* There is no neutral path for agent semantics like purpose, consent, attribution, or receipts. Those live outside the scope and get pushed back to vendor features and rule phases.
...
* **Curation equals signal quality**, and a signal you can sell. Manual vetting and traffic minimums keep the “verified” flag clean for enterprise buyers.
...
1. **Agent-first taxonomy and signals**
   Treat agents as principals with roles and purposes, not just as crawlers with better manners. Expose portable fields that let sites reason about agent classes without vendor lock.
